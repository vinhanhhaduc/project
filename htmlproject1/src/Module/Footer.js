...
export default function Footer() {
  return (
    <div className="pl-10 items-center relative">
      <div className="flex flex-wrap gap-2 justify-between text-3xl  max-md:max-w-full max-md:text-4xl">
        ...
        <div className="flex flex-wrap gap-10 self-start mt-5 font-medium text-black max-md:max-w-full max-md:text-4xl">
          <div className="max-md:text-4xl mr-[260px] text-4xl font-bold mt-10">Page</div>
          <div className="self-start max-md:text-3xl text-4xl font-bold mt-10 mr-[480px]">Contact Us </div>
        </div>
      </div>
      <div className="flex gap-5 justify-between max-md:mr-2.5 max-md:max-w-full">
        ...
        <div className="flex flex-col mr-[210px] text-3xl text-center">
          <div className="flex flex-wrap whitespace-nowrap text-3xl">
            <img
              loading="lazy"
            ...
            />
            <div className="flex-auto my-auto w-[408px]">
              carbreezyCar@gmail.com
            </div>
          </div>
          <div className="flex gap-6 self-start mt-12 text-white max-md:mt-10">
            <img
              loading="lazy"
            ...
            <div className="flex-auto my-auto">
              <span className="text-zinc-800">Hotline: </span>
              <a
                href="tel:0825355355"
